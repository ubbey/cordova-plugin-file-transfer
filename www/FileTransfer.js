	...
	*/
	FileTransfer.prototype.upload = function (opt) {
		...
		var win = function (result) {
			...
			if (result.lengthComputable) {
				...
				if (self.successCallback) {
				   console.log("上传任务结束：" + JSON.stringify(result));
					//出错则发起重试
					let response = {};
					try {
	 ...
	 */
	FileTransfer.prototype.download = function (opt) {
		...
		console.log("开始下载........." + JSON.stringify(this.options));
				   if(opt && opt.offset) {
				   this.options.params.offset = opt.offset;
				   }
				   if(opt && opt.total) {
				   this.options.params.total = opt.total;
				   }
	...
	FileTransfer.prototype.resume = function (opt) {
